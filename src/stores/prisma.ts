 ...
 * `create` and `delete` on it — hooksentinel never generates or migrates your schema.
 *
 * ```prisma
...
export interface PrismaStoreConfig {
   ...
   * hooksentinel does not import `@prisma/client` — pass your own generated client's delegate,

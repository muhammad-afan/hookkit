...
/**
 * Build-your-own adapter for a provider hooksentinel doesn't ship yet. Config-driven: you
 * supply the header shape, algorithm, and exactly how the signed bytes are constructed
 * — hooksentinel still handles decoding, the HMAC comparison (`subtle.verify`, constant-
